...
pub async fn place_order_with<K: ApiKeyRepo, S: Signer, H: Http>(
    db: &PgPool,
    user_id: i64,
    order: &OrderRequest,
    is_demo: bool,
...
#[allow(clippy::too_many_arguments)]
pub async fn get_balance_with<K: ApiKeyRepo, S: Signer, H: Http>(
    db: &PgPool,
    user_id: i64,
    is_demo: bool,
    master_key: &[u8],
...
mod tests {
    ...
    impl Signer for MockSigner {
        ...
        fn sign(&self, _s: &str, _m: &str, _p: &str, _t: &str, _n: &str, _b: &str) -> String {
            "SIGN".into()
        }
    }
    ...
    impl StubHttp {
        fn new(code: &'static str) -> Self {
            Self {
                ...
                last_hdrs: Default::default(),
                hit_post: Default::default(),
                hit_get: Default::default(),
                code,
            }
        }
    }
